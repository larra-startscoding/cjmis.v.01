<?php
    ...
    if(isset($_POST['add'])){
      ...
      //add
      $sql="INSERT INTO tblministry_title(mintitle_name) values ('$mintitle')";
    ...
    if(isset($_POST['del'])){
      ...
      $sql="DELETE FROM tblministry_title WHERE mintitle_id='$getID'";  
      if(!$result=mysqli_query($connection,$sql)){
        exit(mysqli_error($connection));
      }
    }
    ...
    //edit
    if(isset($_POST['edit'])){
      $titleid=$_POST['hiddenID'];
      $mintitle=$_POST['update_mintitle'];

      $sql="UPDATE tblministry_title SET mintitle_name='$mintitle' WHERE mintitle_id=$titleid";  
      if(!$result=mysqli_query($connection,$sql)){
        exit(mysqli_error($connection));
      }
    }
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <ul class="nav flex-column mb-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="ministryTitle.php">
                  <span data-feather="file-text"></span>
                  Ministerial Title
                </a>
              </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Manage Ministerial Title</h1>
          ...
          <!--    table      -->
              <div class="table-responsive">
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                    <?php
                      $sql="SELECT * FROM tblministry_title";
                      $result=mysqli_query($connection,$sql);
                      while($row=mysqli_fetch_array($result))
                      {
                    ?>
                    <tr>
                      <td><?php echo $row['mintitle_name']?></td>
                      <td>
                        <button type="button" class="btn btn-primary btn-sm" name="edit" data-toggle="modal" data-target="#editModal" onclick="getDetails(<?php echo $row['mintitle_id']; ?>,'<?php echo $row['mintitle_name']; ?>');">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm" name="delete" data-toggle="modal" data-target="#delModal" onclick="deletexid(<?php echo $row['mintitle_id']; ?>);">Delete</button>
                      </td>
                    </tr>
                    <?php
                      }
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  <label for="minName" class="control-label">Title</label>
                  <input type="text" name="mintitle" class="form-control" placeholder="Title" required autofocus>
                </div>
              </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="card-body">
                  <div class="form-group">
                    <label for="minName" class="control-label">Title</label>
                    <input type="text" name="update_mintitle" class="form-control" required autofocus></input>
                  </div>
                </div>
              </div>
              <div class="modal-footer">
...
<script>
  ...
  function getDetails(id,mintitle){
    $('input[name="update_mintitle"]').val(mintitle);
    $("#hiddenid").val(id);
  }

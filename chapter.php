<?php
    ...
    if(isset($_POST['add'])){
      ...
      $addr=$_POST['address'];
      //add
      $sql="INSERT INTO tblchapter(chapter,chapter_address) values ('$chap','$addr')";
    ...
    if(isset($_POST['del'])){
      ...
      $sql="DELETE FROM tblchapter WHERE chapter_id='$getID'";  
      if(!$result=mysqli_query($connection,$sql)){
        exit(mysqli_error($connection));
      }
    }
    ...
    //edit
    if(isset($_POST['edit'])){
      $chapid=$_POST['hiddenID'];
      $chap=$_POST['update_chap'];
      $addr=$_POST['update_addr'];

      $sql="UPDATE tblchapter SET chapter='$chap',chapter_address='$addr' WHERE chapter_id=$chapid";  
      if(!$result=mysqli_query($connection,$sql)){
        exit(mysqli_error($connection));
      }
    }
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <ul class="nav flex-column mb-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="chapter.php">
                  <span data-feather="file-text"></span>
                  Chapter
                </a>
              </li>
                ...
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['chapter_address']?></td>
                      <td>
                        <button type="button" class="btn btn-primary btn-sm" name="edit" data-toggle="modal" data-target="#editModal" onclick="getDetails(<?php echo $row['chapter_id']; ?>,'<?php echo $row['chapter']; ?>','<?php echo $row['chapter_address']; ?>');">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm" name="delete" data-toggle="modal" data-target="#delModal" onclick="deletexid(<?php echo $row['chapter_id']; ?>);">Delete</button>
                      </td>
                    </tr>
                    <?php
                      }
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="text" name="chapter" class="form-control" placeholder="Chapter" required autofocus>
                </div>
                <div class="form-group">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="card-body">
                  <div class="form-group">
                    <label for="minName" class="control-label">Chapter</label>
                    <input type="text" name="update_chap" class="form-control" required autofocus></input>
                  </div>
                  <div class="form-group">
                    <label for="minName" class="control-label">Address</label>
                    <input type="text" name="update_addr" class="form-control" required></input>
                  </div>
                </div>
              </div>
              <div class="modal-footer">
...
<script>
  ...
  function getDetails(id,chap,addr){
    $('input[name="update_chap"]').val(chap);
    $('input[name="update_addr"]').val(addr);
    $("#hiddenid").val(id);
  }
